      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-5">
          ...
          <div className="card p-6">
            ...
            <div className="text-sm text-gray-400 space-y-1">
              <p className="font-medium text-white">{shippingAddress.label}</p>
              <p>{shippingAddress.street}</p>
              <p>{shippingAddress.city}, {shippingAddress.state} – {shippingAddress.pincode}</p>
              <p>{shippingAddress.country}</p>
              <p className="text-brand-300">📞 +91 {shippingAddress.phone}</p>
            </div>
          </div>
          ...
          <div className="card p-6">
            ...
            <div className="flex items-center gap-3 p-3 rounded-xl bg-surface-elevated border border-brand-500/30">
        ...
        <div>
          <div className="card p-6 sticky top-24">
            <h2 className="font-semibold text-white text-lg mb-5">Price Details</h2>
