      ...
      <div className="container-max px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-3 mt-4">
              <a href="#" className="w-9 h-9 rounded-xl bg-surface-elevated border border-surface-border flex items-center justify-center text-gray-400 hover:text-brand-300 hover:border-brand-500 transition-all">
              ...
              {['Kurti', 'Saree', 'Lehenga', 'Salwar Suit', 'Dupatta', 'New Arrivals'].map((item) => (
                <li key={item}>
                  <Link
                    ...
                    className="text-sm text-gray-500 hover:text-brand-300 transition-colors"
                  >
                    {item}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={label}>
                  <Link to={to} className="text-sm text-gray-500 hover:text-brand-300 transition-colors">
                    {label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="mt-4 p-3 rounded-xl bg-surface-elevated border border-surface-border">
              <p className="text-xs text-gray-500">
                <span className="text-brand-300 font-medium">Fast Delivery:</span> 3–5 business days across India.
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-4">
            <Link to="/privacy" className="text-xs text-gray-600 hover:text-brand-300 transition-colors">Privacy Policy</Link>
            <Link to="/terms" className="text-xs text-gray-600 hover:text-brand-300 transition-colors">Terms of Service</Link>
          </div>
